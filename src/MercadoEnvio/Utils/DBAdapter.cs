    ...
    class DBAdapter
    {
        ...
        private static void _executeProcedure(string procedure, List<string> args, params object[] values)
        {
            ...
            try
            {
                ...
                cm.CommandText = "TODO_X2_LUCAS." + procedure;
        ...
        private static List<string> _generateArguments(string procedure)
        {
            ...
            try
            {
                ...
                cm.CommandText = "SELECT PARAMETER_NAME FROM information_schema.parameters WHERE SPECIFIC_SCHEMA='TODO_X2_LUCAS' AND SPECIFIC_NAME='" + procedure + "'";
                dr = cm.ExecuteReader();
                dt.Load(dr);
